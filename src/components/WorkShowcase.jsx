    ...
    <section id="work" className="relative w-full bg-black text-white">
      <div className="mx-auto max-w-7xl px-6 py-20">
        <div className="mb-10 flex items-end justify-between gap-6">
          ...
          <a href="#contact" className="hidden rounded-md border border-white/20 px-4 py-2 text-sm text-white/80 hover:border-white/40 md:block">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {projects.map((p) => (
            <a key={p.title} href={p.link} className="group overflow-hidden rounded-xl border border-white/10 bg-white/5 transition hover:bg-white/10">
